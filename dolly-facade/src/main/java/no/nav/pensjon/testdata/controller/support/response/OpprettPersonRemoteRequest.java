...
public class OpprettPersonRemoteRequest {
    ...
    public OpprettPersonRemoteRequest() {
        super();
    }

    public OpprettPersonRemoteRequest(String fnr, Date fodselsDato, Date dodsDato, Date utvandringsDato, String bostedsland) {
        this.fnr = fnr;
