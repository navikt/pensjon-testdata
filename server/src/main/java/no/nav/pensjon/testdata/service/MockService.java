...
public class MockService {
    ...
    public void iverksett(Long vedtakId, String server, String database, String username, String password) throws IOException, SQLException {
    ...
    public void attester(Long vedtakId, String server, String database, String username, String password) throws IOException, SQLException {
        JdbcTemplate jdbcTemplate = oracleRepository.createJdbcTemplate(server, database, username, password);
        DataSourceTransactionManager transactionManager = new DataSourceTransactionManager(jdbcTemplate.getDataSource());
        TransactionTemplate transactionTemplate = new TransactionTemplate(transactionManager);
    ...
    public void flyttEnhet(Long sakId, Long enhetId, String server, String database, String username, String password) throws IOException, SQLException {
        JdbcTemplate jdbcTemplate = oracleRepository.createJdbcTemplate(server, database, username, password);
        DataSourceTransactionManager transactionManager = new DataSourceTransactionManager(jdbcTemplate.getDataSource());
        TransactionTemplate transactionTemplate = new TransactionTemplate(transactionManager);
